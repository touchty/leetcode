...
public class EliminationGame {
    public int lastRemaining(int n) {
        ...
        int step = 1;
        int head = 1;
        // if we move from right and the total remaining number % 2 == 0
        // then the head is not changed.
        // if we move from left to right or the total remaining number % 2 == 1
        // then the head = head + step.
        while (remaining > 1) {
