...
public class LargestSumofAverages {
    public double largestSumOfAverages(int[] A, int K) {
        ...
        //The idea is :
        //Answer(j,K) = Math.max ( Answer(j, K), Answer(j +1, K - 1) + Average( start, j ) );
        //= That's it. No more frills.
        ...
        //Here did you observe that sum[0] doesn't cause problem
        //because sum[0] = 0.0 when the array was  created.
        ...
        //Now again why in the God's name A.length + 1 ?
        //because we are treating sum[] from 1 to A.length,
        //and why K + 1? because K starts from 1 not 0 !!
