...
public class MaximumWidthofBinaryTree {
    ...
    class SolutionOpt {
        ...
        // children are 2*i and 2*i + 1. The idea is to use two arrays (start[] and end[]) to record
        // the the indices of the leftmost node and rightmost node in each level, respectively.
